...
public class LoseOutcomeHandler implements OutcomeHandler {
    ...
    public LoseOutcomeHandler(GridDisplayService<MSCell> displayService, OutputService outputService) {
    ...
    public void handleOutcome(MSGameState gameState, Grid<MSCell> grid) {
        revealCells(grid);
        String gridDisplayString = displayService.displayGridState(grid);
